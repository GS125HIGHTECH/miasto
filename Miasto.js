...
const podwozie2 = new THREE.Mesh ( geometry19, material15 );
podwozie2.position.set(0.5, -8.9, 0.3);
podwozie2.rotation.x-=Math.PI/2.0;

const podwozie3 = new THREE.Mesh ( geometry19, material15 );
...
function animate() {
  requestAnimationFrame( animate );
	...
	auto3.position.x+=0.15;
	
	if(auto3.position.x > 11.5) {
		auto3.position.x=-12; 
	}
	if(auto.position.x > 11.5) {
		auto.position.x=-12; 
	}
	
	if(auto2.position.z < -11.5) {
		auto2.position.z=12; 
	}
	
	auto.position.x+=0.15;
	
	auto2.position.z-=0.15;
