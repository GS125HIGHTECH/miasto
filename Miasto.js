...
// lights controls
  ...
  document.getElementById( 'Sun-light' ).addEventListener(
    'click',
    function() {
      this.className = this.className.indexOf( 'inactive' ) > -1 ? 'active' : 'inactive';
      Sun.intensity = Sun.intensity==1 ? 0 : 1;
      renderer.render( scene, camera );
    },
    false
  );
