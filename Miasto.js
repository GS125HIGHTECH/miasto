...
const colors = [ 0xFF0000, 0x00FF00, 0x0000FF, 0xFF6347, 0x228B22, 0x1E90FF,
 ...
 var div5 = document.getElementById("Dron");
 var div6 = document.getElementById("Auto");
 var audio = new Audio();
...
const cubeTexture14 = new THREE.TextureLoader().load( 'textures/tire.jpg' );
  ...
  const cubeTexture18 = new THREE.TextureLoader().load( 'textures/desk.jpg' );
  cubeTexture18.wrapS = THREE.RepeatWrapping;
  cubeTexture18.wrapT = THREE.RepeatWrapping;
  cubeTexture18.repeat.set( 1, 1 );
...
const geometry24 = new THREE.BoxGeometry( 0.07, 0.5, 0.5 );
const geometry25 = new THREE.BoxGeometry( 0.01, 0.1, 0.3 );
const geometry26 = new THREE.CylinderGeometry( 0.025, 0.025, 0.05, 16 );
const geometry27 = new THREE.BoxGeometry( 0.01, 0.25, 0.5 );
...
const material23 = new THREE.MeshStandardMaterial( { color: 0xC79162, map: cubeTexture18 } );
const material24 = new THREE.MeshStandardMaterial( { color: 0x141414} );

const podstawka1 = new THREE.Mesh( geometry25, material24 );
podstawka1.rotation.z+=Math.PI/2.0;

const podstawka2 = new THREE.Mesh( geometry26, material24 );
podstawka2.position.y+=0.025;

const ekran = new THREE.Mesh( geometry27, material24 );
ekran.position.y+=0.165;

const telewizor = new THREE.Group();
telewizor.add(podstawka1);
telewizor.add(podstawka2);
telewizor.add(ekran);
telewizor.rotation.y+=1+Math.PI/3.0;
telewizor.scale.set(0.35, 0.35, 0.35)
telewizor.position.set( -9.325, -9.19, 5.735 );

scene.add(telewizor);


const leg1 = new THREE.Mesh( geometry24, material23 );

var leg2 = leg1.clone();
leg2.position.x+=0.5;

var leg3 =leg1.clone();
leg3.rotation.z+=Math.PI/2.0;
leg3.position.y+=0.215;
...
biurko.scale.set(0.35, 0.35, 0.35);
biurko.position.set( -9.444, -9.28, 5.7 );
scene.add(biurko);
...
dywanik.position.set( -9, -9.34, 6.1 );
...
const pointLight8 = new THREE.PointLight( 0x135DD8, 2, 2 );
 pointLight8.position.set(1.2, -8.9, 0.3 );
  ...
  pointLight8.name = "pointLight8";
  scene.add( pointLight8 );
  
const pointLight9 = new THREE.PointLight( 0xF8F8FF, 2, 2 );
pointLight9.castShadow = true;
pointLight9.position.set(0.4, -8.7, 0.4);
pointLight9.name = "pointLight9";

const pointLight10 = new THREE.PointLight( 0xF8F8FF, 2, 2 );
pointLight10.castShadow = true;
pointLight10.position.set(0.3, -8.7, 0.3);
pointLight10.name = "pointLight10";

const pointLight11 = new THREE.PointLight( 0xF8F8FF, 3, 3 );
pointLight11.name = "pointLight11";
lampa.add(pointLight11);
...
var lampa1_3 = lampa.clone();
lampa1_3.position.set(-12.5, -9.45, -2.5);
scene.add( lampa1_3 );
var lampa1_4 = lampa.clone();
lampa1_4.position.set(-12.5, -9.45, -6.5);
scene.add( lampa1_4 );
var lampa1_5 = lampa.clone();
lampa1_5.position.set(-12.5, -9.45, -10.5);
scene.add( lampa1_5 );
var lampa1_6 = lampa.clone();
lampa1_6.position.set(-12.5, -9.45, -12.5);
scene.add( lampa1_6 );
var lampa1_7 = lampa.clone();
lampa1_7.position.set(-10.5, -9.45, -12.5);
scene.add( lampa1_7 );
var lampa1_8 = lampa.clone();
lampa1_8.position.set(-6.5, -9.45, -12.5);
scene.add( lampa1_8 );
var lampa1_9 = lampa.clone();
lampa1_9.position.set(-2.5, -9.45, -12.5);
scene.add( lampa1_9 );
var lampa1_10 = lampa.clone();
lampa1_10.position.set(2.5, -9.45, -12.5);
scene.add( lampa1_10 );
var lampa1_11 = lampa.clone();
lampa1_11.position.set(6.5, -9.45, -12.5);
scene.add( lampa1_11 );

var lampa1_12 = lampa.clone();
lampa1_12.position.set(10.5, -9.45, -12.5);
scene.add( lampa1_12 );

var lampa1_13 = lampa.clone();
lampa1_13.position.set(12.5, -9.45, -12.5);
scene.add( lampa1_13 );

var lampa1_14 = lampa.clone();
lampa1_14.position.set(12.5, -9.45, -10.5);
scene.add( lampa1_14 );

var lampa1_15 = lampa.clone();
lampa1_15.position.set(12.5, -9.45, -6.5);
scene.add( lampa1_15 );

var lampa1_16 = lampa.clone();
lampa1_16.position.set(12.5, -9.45, -2.5);
scene.add( lampa1_16 );

var lampa1_17 = lampa.clone();
lampa1_17.position.set(12.5, -9.45, 2.5);
scene.add( lampa1_17 );

var lampa1_18 = lampa.clone();
lampa1_18.position.set(12.5, -9.45, 6.5);
scene.add( lampa1_18 );

var lampa1_19 = lampa.clone();
lampa1_19.position.set(12.5, -9.45, 10.5);
scene.add( lampa1_19 );

var lampa1_20 = lampa.clone();
lampa1_20.position.set(12.5, -9.45, 12.5);
scene.add( lampa1_20 );

var lampa1_21 = lampa.clone();
lampa1_21.position.set(10.5, -9.45, 12.5);
scene.add( lampa1_21 );

var lampa1_22 = lampa.clone();
lampa1_22.position.set(6.5, -9.45, 12.5);
scene.add( lampa1_22 );

var lampa1_23 = lampa.clone();
lampa1_23.position.set(2.5, -9.45, 12.5);
scene.add( lampa1_23 );

var lampa1_24 = lampa.clone();
lampa1_24.position.set(-2.5, -9.45, 12.5);
scene.add( lampa1_24 );

var lampa1_25 = lampa.clone();
lampa1_25.position.set(-6.5, -9.45, 12.5);
scene.add( lampa1_25 );

var lampa1_26 = lampa.clone();
lampa1_26.position.set(-10.5, -9.45, 12.5);
scene.add( lampa1_26 );

var lampa1_27 = lampa.clone();
lampa1_27.position.set(-12.5, -9.45, 12.5);
scene.add( lampa1_27 );

var lampa1_28 = lampa.clone();
lampa1_28.position.set(-12.5, -9.45, 10.5);
scene.add( lampa1_28 );

var lampa1_29 = lampa.clone();
lampa1_29.position.set(-12.5, -9.45, 6.5);
scene.add( lampa1_29 );

var lampa1_30 = lampa.clone();
lampa1_30.position.set(-12.5, -9.45, 2.5);
scene.add( lampa1_30 );
...
lampa2.position.x-=2;
scene.add( lampa2 );
var lampa3 = lampa.clone();
lampa3.position.z+=2.4;
lampa3.position.x-=14;
scene.add( lampa3 );
...
scene.add( auto );
auto.getObjectByName( "pointLight10" ).position.x+= 1.5;
...
scene.add( auto4 );
auto4.getObjectByName( "pointLight10" ).position.x-= 2;

var auto5 = auto2.clone();
auto5.position.z-=1.3;
auto5.position.x-=3.3;
auto5.position.y+=0.2;
auto5.add( pointLight9 );
// auto5.rotation.y+=Math.PI;
scene.add( auto5 );


// Create a new material with the desired color
var newMaterial5 = new THREE.MeshLambertMaterial({ color: 0x326647 });
var newMaterial6 = new THREE.MeshLambertMaterial({ color: 0x326647 });
...
var nadwozie5_1 = auto6.children.find(function(child){
  return child.name === "nadwozie5";
});
var nadwozie6_1 = auto6.children.find(function(child){
  return child.name === "nadwozie6";
});
nadwozie5_1.material = newMaterial5;
nadwozie6_1.material = newMaterial6;
...
scene.add( auto7 );
auto7.getObjectByName( "pointLight8" ).position.y+= 1.2;

var autko = auto3.clone();
autko.scale.set(0.05, 0.05, 0.05);
autko.position.set( -9, -8.878, 6 );
scene.add(autko);

var autko2 = auto6.clone();
autko2.scale.set(0.05, 0.05, 0.05);
autko2.position.set( -9.1, -8.878, 6 );
scene.add(autko2);

var autko3 = auto2.clone();
autko3.scale.set(0.05, 0.05, 0.05);
autko3.position.set( -8.9, -8.878, 6 );
scene.add(autko3);

var autko4 = auto.clone();
autko4.scale.set(0.05, 0.05, 0.05);
autko4.position.set( -8.85, -8.878, 5.9 );
scene.add(autko4);
...
// Lights and helpers
  ...
  const Sun = new THREE.HemisphereLight( 0xffffcc, 0x080820, 0.4 );
  scene.add( Sun );
...
function animate() {
  ...
  autko4.getObjectByName( "pointLight10" ).intensity = 0;
...
{
      pointLight11.intensity=0;
      lampa1.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_1.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_2.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_3.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_4.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_5.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_6.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_7.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_8.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_9.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_10.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_11.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_12.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_13.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_14.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_15.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_16.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_17.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_18.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_19.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_20.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_21.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_22.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_23.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_24.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_25.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_26.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_27.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_28.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_29.getObjectByName( "pointLight11" ).intensity = 0;
      lampa1_30.getObjectByName( "pointLight11" ).intensity = 0;
      lampa2.getObjectByName( "pointLight11" ).intensity = 0;
      lampa3.getObjectByName( "pointLight11" ).intensity = 0;
      lampa4.getObjectByName( "pointLight11" ).intensity = 0;
      lampa5.getObjectByName( "pointLight11" ).intensity = 0;
      lampa6.getObjectByName( "pointLight11" ).intensity = 0;
      lampa7.getObjectByName( "pointLight11" ).intensity = 0;
      auto5.getObjectByName( "pointLight9" ).intensity = 0;
      auto4.getObjectByName( "pointLight10" ).intensity = 0;
}
else
{
  pointLight11.intensity=1;
      lampa1.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_1.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_2.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_3.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_4.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_5.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_6.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_7.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_8.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_9.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_10.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_11.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_12.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_13.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_14.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_15.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_16.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_17.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_18.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_19.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_20.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_21.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_22.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_23.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_24.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_25.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_26.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_27.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_28.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_29.getObjectByName( "pointLight11" ).intensity = 1;
      lampa1_30.getObjectByName( "pointLight11" ).intensity = 1;
      lampa2.getObjectByName( "pointLight11" ).intensity = 1;
      lampa3.getObjectByName( "pointLight11" ).intensity = 1;
      lampa4.getObjectByName( "pointLight11" ).intensity = 1;
      lampa5.getObjectByName( "pointLight11" ).intensity = 1;
      lampa6.getObjectByName( "pointLight11" ).intensity = 1;
      lampa7.getObjectByName( "pointLight11" ).intensity = 1;
      auto5.getObjectByName( "pointLight9" ).intensity = 1;
      auto4.getObjectByName( "pointLight10" ).intensity = 1;
}
